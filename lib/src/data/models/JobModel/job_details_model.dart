...
class JobDetailsModel extends BaseMappable{
  int? httpStatusCode;
  bool? succeeded;
  String? message;
  Null? errors;
  ...
  JobDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? new JobDetails.fromJson(json['data']) : null;
  }
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    modelErrors = json['modelErrors'];
    data = json['data'] != null ? new JobDetails.fromJson(json['data']) : null;
    return JobDetailsModel(succeeded: succeeded,data: data,errors: errors,message: message,
    modelErrors: modelErrors,httpStatusCode: httpStatusCode);
  }
}
...
class JobDetails {
  ...
  JobDetails.fromJson(Map<String, dynamic> json) {
    ...
    if (json['jobSkillResultList'] != null) {
      jobSkillResultList = <JobSkillResultList>[];
      json['jobSkillResultList'].forEach((v) {
        jobSkillResultList!.add(new JobSkillResultList.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.jobSkillResultList != null) {
      data['jobSkillResultList'] =
          this.jobSkillResultList!.map((v) => v.toJson()).toList();
    }
...
class JobSkillResultList {
  int? skillId;
  String? skillName;

  JobSkillResultList({this.skillId, this.skillName});

  JobSkillResultList.fromJson(Map<String, dynamic> json) {
