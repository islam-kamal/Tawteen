...
class PreviousInitativesModel extends BaseMappable{
  int? httpStatusCode;
  bool? succeeded;
  String? message;
  Null? errors;
  Null? modelErrors;
  List<PreviousInitative>? data;
  ...
  PreviousInitativesModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <PreviousInitative>[];
      json['data'].forEach((v) {
        data!.add(new PreviousInitative.fromJson(v));
      });
    }
  }
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    return PreviousInitativesModel(succeeded: succeeded,httpStatusCode: httpStatusCode,data: data,
    modelErrors: modelErrors,errors: errors,message: message);
  }
}

class PreviousInitative {
  int? id;
  int? noId;
  String? fullName;
  String? phone;
  ...
  PreviousInitative.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    noId = json['noId'];
    ...
    suspendEndDate = json['suspendEndDate'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['suspendEndDate'] = this.suspendEndDate;
