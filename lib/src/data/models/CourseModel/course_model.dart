...
class CourseModel extends BaseMappable{
  int? httpStatusCode;
  bool? succeeded;
  String? message;
  Null? errors;
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    return CourseModel(message: message,errors: errors,httpStatusCode: httpStatusCode,modelErrors: modelErrors,
...
class Course {
 ...
 /*   if (json['skillsIdList'] != null) {
      ...
      json['skillsIdList'].forEach((v) {
        skillsIdList!.add(new Null.fromJson(v));
      });
    }*/
