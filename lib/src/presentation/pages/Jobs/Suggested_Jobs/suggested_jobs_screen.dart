...
import 'package:code/src/presentation/bloc/Jobs_Bloc/suggested_jobs_bloc.dart';
import 'package:code/src/presentation/widgets/unathorized_user_widget.dart';

class SuggestedJobScreen extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return SuggestedJobScreenState();
  }
}

class SuggestedJobScreenState extends State<SuggestedJobScreen>{
  @override
  void initState() {
...
void get_data()async{
  if(Shared.vistor_value != 'visitor')
    suggestedJobsBloc.add(GetSuggestedJobsEvent(
      jobTitleId: await sharedPreferenceManager.readInt(CachingKey.SUGGESTED_JIBS_JOB_TITLE_ID),
      cityId: await sharedPreferenceManager.readInt(CachingKey.SUGGESTED_JIBS_CITY_ID)
    ));
}
  @override
      ...
      child: PageContainer(
        child: Directionality(
            ...
            child:Scaffold(
              ...
              body: Shared.vistor_value == 'visitor' ? UnAuthorizedUserWidget(): Container(
                  color: kGreenColor,
                  child:Container(
                        ...
                        builder: (context,state){
                          if(state is Loading){
                            ...
                            return StreamBuilder<AllJobsModel>(
                                stream: suggestedJobsBloc.suggested_jobs_subject,
    ...
    return InkWell(
      onTap: () {
        customAnimatedPushNavigation(context, JobDetailsScreen(
            ...
            image_path: baseUrl + job.attachments!.firstWhere((element) => element.status ==1).filePath!
        ));
      },
      child: Container(
        decoration: BoxDecoration(
