...
class InitativesDetailsScreen extends StatefulWidget {
  ...
  InitativesDetailsScreen({this.iniatives_id,this.screen,this.show_cancellation_status = false,this.previous_iniatives_status});
  @override
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              widget.show_cancellation_status!
                                                                  ...
                                                                  padding: EdgeInsets.symmetric(vertical: Shared.width * 0.05),
                                                                  child: CustomButtonWidget(
                                                                    button_text: ksubmitinitatives.tr(),
                                                                    width: Shared.width ,
                                                                    height: Shared.width * 0.13,
                                                                    onPress: () {
        ...
        children: [
          Expanded(
              ...
              child: Padding(
                  ...
                  child: /*FadeInImage(
                    image: NetworkImage(baseUrl + initativesDetails!.attachments!.firstWhere((element) => element.status ==1).filePath!),
